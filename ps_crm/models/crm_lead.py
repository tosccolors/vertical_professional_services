...
class CRMRevenueSplit(models.Model):
    ...
    ps_blue_bv_amount = fields.Float(oldname='mangnus_blue_bv_amount', string='Magnus Blue B.V.')
    ps_blue_bv_per = fields.Float(oldname='mangnus_blue_bv_per', string='Magnus Blue B.V. %')
    ps_red_bv_amount = fields.Float(oldname='mangnus_red_bv_amount', string='Magnus Red B.V.')
    ps_red_bv_per = fields.Float(oldname='mangnus_red_bv_per', string='Magnus Red B.V. %')
    ps_green_bv_amount = fields.Float(oldname='mangnus_green_bv_amount', string='Magnus Green B.V.')
    ps_green_bv_per = fields.Float(oldname='mangnus_green_bv_per', string='Magnus Green B.V. %')
    ps_black_bv_amount = fields.Float(oldname='mangnus_black_bv_amount', string='Magnus Black B.V.')
    ps_black_bv_per = fields.Float(oldname='mangnus_black_bv_per', string='Magnus Black B.V. %')
    
    @api.constrains('ps_blue_bv_per', 'ps_red_bv_per','ps_green_bv_per','ps_black_bv_per')
    def _check_dates(self):
        total_per = self.ps_blue_bv_per + self.ps_red_bv_per + self.ps_green_bv_per + self.ps_black_bv_per
